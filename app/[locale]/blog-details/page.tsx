...
const BlogDetailsPage = () => {
  ...
  useEffect(() => {
    const index = Cookies.get("id");
    setData(blogData[parseInt(index) - 1]);
    if (index === "1") {
      setTitle(msg("captions.1"));
      setMiniTitles(msg("contents.1.title").split("//"));
      setParagraphs(msg("contents.1.paragraph").split("//"));
    } else if (index === "2") {
      setTitle(msg("captions.2"));
      setMiniTitles(msg("contents.2.title").split("//"));
      setParagraphs(msg("contents.2.paragraph").split("//"));
    } else {
      setTitle(msg("captions.3"));
      setMiniTitles(msg("contents.3.title").split("//"));
